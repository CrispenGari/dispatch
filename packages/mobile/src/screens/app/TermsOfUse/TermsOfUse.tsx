  ...
  return (
    ...
    >
      ...
      <Text style={[styles.p, { marginTop: 10 }]}>
        Dispatch Inc. is committed to ensuring that the app is as useful and
      ...
      <Text style={[styles.p, { marginTop: 10 }]}>
        The Dispatch app stores and processes personal data that you have
        ...
        features and it could mean that the Dispatch app won’t work properly or
        at all. The app does use third-party services that declare their Terms
        and Conditions.
      </Text>
      <Text style={[styles.p, { marginTop: 10 }]}>
        You should be aware that there are certain things that Dispatch Inc.
        ...
        can be Wi-Fi or provided by your mobile network provider, but Dispatch
        Inc. cannot take responsibility for the app not working at full
      ...
      <Text style={[styles.p, { marginTop: 10 }]}>
        Along the same lines, Dispatch Inc. cannot always take responsibility
        ...
        avail the Service, Dispatch Inc. cannot accept responsibility.
      </Text>
      <Text style={[styles.p, { marginTop: 10 }]}>
        With respect to Dispatch Inc.’s responsibility for your use of the app,
        ...
        it available to you. Dispatch Inc. accepts no liability for any loss,
      ...
      <Text style={[styles.p, { marginTop: 10 }]}>
        ...
        using the app. Dispatch Inc. does not promise that it will always update
      ...
      <Text style={[styles.p, { marginTop: 10 }]}>
        These terms and conditions are effective as of 2023-07-01
      </Text>
      <Text style={[styles.h1, { marginTop: 15, fontSize: 20 }]}>
        Contact Us
      </Text>
      <Text style={[styles.p, { marginTop: 10 }]}>
        ...
        do not hesitate to contact us at crispengari@gmail.com.
      </Text>
    </ScrollView>
  );
};
